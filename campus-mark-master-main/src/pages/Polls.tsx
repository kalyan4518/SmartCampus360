...
import { ArrowLeft, BarChart3, CheckCircle2, Plus, CalendarDays, Trash2 } from "lucide-react";
...
const Polls = () => {
  ...
  const deletePollMutation = useMutation({
    mutationFn: (pollId: string) => api.delete(`/api/polls/${pollId}`),
    onSuccess: () => {
                    ...
                    <div className="flex items-center gap-2">
                      ...
                      {currentUser?.role === "admin" && (
                        <Button
                          ...
                          onClick={() => deletePollMutation.mutate(poll._id)}
